...
def anal(request):
    ...
    if keyword3:
        ...
        #print(keyword_hwf_2)
            ...
            #dict_keyword = {}
            #hwf_values = [i for i in u.values()]
            #hwf_keys = [i for i in u.keys()]
            #print(hwf_values)
            #print(hwf_keys)
        context = {'keyword_word':keyword_word, 'a1':a1, 'a2':a2,'a3':a3,'a4':a4,'a5':a5,'a6':a6,'a7':a7,'a8':a8, 'a9':a9, 'b1':b1, 'b2':b2, 'b3':b3, 'b4':b4, 'b5':b5, 'b6':b6, 'b7':b7, 'b8':b8, 'b9':b9}
        ...
        title_urls = zip(read_csv(created))
        print(title_urls)
        # print(urls)
        # print(titles)
        context = {'result2': result2,
                   'readtxt': readtxt, 'title_urls': title_urls}
...
def read_csv(current_time):
    ...
    titles = []
    urls = []
    with open(f'/home/sunny/ubuntu/Project/Final_Project/Devel1/{current_ymd}/{current_time0}/output.csv', 'r', encoding='utf-8-sig') as csv_file:
