...
def anal(request):
    ...
    # strkeyword2 = json.dumps(
    #     list(keyword2), cls=DjangoJSONEncoder, ensure_ascii=False, indent=1)
    # replacestrkeyword2 = strkeyword2.replace("\\", "")
    #print(keyword2[0]['high_word_frequency'])
    
    keyword_hwf = keyword2[0]['high_word_frequency']
    b = json.loads(keyword_hwf, encoding='utf-8')
    c = json.loads(b)
    #print(b.values)
    print(c)
    print(type(c))
    print(c.values())
    print(c.keys())
    d = [ i for i in c.values()]
    print(d)
    # print(replacestrkeyword2['id'])
