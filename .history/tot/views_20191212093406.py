...
def anal(request):
    ...
    shutil.copy('/home/sunny/ubuntu/Project/Final_Project/Devel1/text.txt', '/root/.pyenv/versions/3.7.4/lib/python3.7/site-packages/konlpy/data/corpus/kolaw/a.txt')
    ...
    # POS tag a sentence
    shutil.copy('text.txt', '/root/.pyenv/versions/3.7.4/lib/python3.7/site-packages/konlpy/data/corpus/kolaw/a.txt')
    ...
    pprint(result[0:100])  # print chunks and counting
